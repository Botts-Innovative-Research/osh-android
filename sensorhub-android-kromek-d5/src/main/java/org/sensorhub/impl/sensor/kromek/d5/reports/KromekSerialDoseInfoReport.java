...
import org.sensorhub.impl.sensor.kromek.d5.enums.KromekSerialDosemeterSource;
...
public class KromekSerialDoseInfoReport extends SerialReport {
    ...
    public KromekSerialDoseInfoReport() {
        this(KROMEK_SERIAL_COMPONENT_INTERFACE_BOARD, KROMEK_SERIAL_REPORTS_IN_DOSE_INFO_ID, null);
    }
