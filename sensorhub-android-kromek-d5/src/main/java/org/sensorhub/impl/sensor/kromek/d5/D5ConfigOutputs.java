...
/**
 * Configuration class for the Kromek D5 driver's outputs
 *
 * @author Michael Elmore
 * @since Oct. 2023
 */
public class D5ConfigOutputs {
    public Set<String> enabledReports;

    public void parseEnabledReports() {
        enableKromekDetectorRadiometricsV1Report = enabledReports.contains("KromekDetectorRadiometricsV1Report");
        enableKromekSerialRadiometricStatusReport = enabledReports.contains("KromekSerialRadiometricStatusReport");
        enableKromekSerialCompressionEnabledReport = enabledReports.contains("KromekSerialCompressionEnabledReport");
        enableKromekSerialEthernetConfigReport = enabledReports.contains("KromekSerialEthernetConfigReport");
        enableKromekSerialStatusReport = enabledReports.contains("KromekSerialStatusReport");
        enableKromekSerialUnitIDReport = enabledReports.contains("KromekSerialUnitIDReport");
        enableKromekSerialDoseInfoReport = enabledReports.contains("KromekSerialDoseInfoReport");
        enableKromekSerialRemoteIsotopeConfirmationReport = enabledReports.contains("KromekSerialRemoteIsotopeConfirmationReport");
        enableKromekSerialRemoteIsotopeConfirmationStatusReport = enabledReports.contains("KromekSerialRemoteIsotopeConfirmationStatusReport");
        enableKromekSerialUTCReport = enabledReports.contains("KromekSerialUTCReport");
        enableKromekSerialRemoteBackgroundStatusReport = enabledReports.contains("KromekSerialRemoteBackgroundStatusReport");
        enableKromekSerialRemoteExtendedIsotopeConfirmationStatusReport = enabledReports.contains("KromekSerialRemoteExtendedIsotopeConfirmationStatusReport");
        enableKromekSerialUIRadiationThresholdsReport = enabledReports.contains("KromekSerialUIRadiationThresholdsReport");
        enableKromekSerialAboutReport = enabledReports.contains("KromekSerialAboutReport");
        enableKromekSerialOTGReport = enabledReports.contains("KromekSerialOTGReport");
    }
