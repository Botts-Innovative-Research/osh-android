...
/**
 * Data class for elevation gain data.
 */
public class ElevationGainData {
    private final long startTime;
    private final long endTime;
    private final double value;

    /**
     * Constructor for elevation gain data.
     *
     * @param startTime The start time of the sampling period.
     * @param endTime   The end time of the sampling period.
     * @param value     The value of the data.
     */
    public ElevationGainData(Instant startTime, Instant endTime, double value) {
