...
public class DistanceOutput extends AbstractSensorOutput<WearOSDriver> {
    ...
    public DistanceOutput(WearOSDriver parent) {
        super("Distance Data", parent);
    }
    ...
    public void doInit() {
        ...
        dataComponent = sweHelper.createRecord()
                .name(name)
                .label(name)
                .definition(SWEHelper.getPropertyUri("distanceData"))
                ...
                .addField("endTimeDaily", sweHelper.createTime()
                        ...
                        .build())
                .addField("distanceDaily", sweHelper.createQuantity()
                        .label("Daily Distance")
                        .description("Daily Distance")
                        .definition(SWEHelper.getPropertyUri("distanceDaily"))
                        .dataType(DataType.DOUBLE))
                .build();
